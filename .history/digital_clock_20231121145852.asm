...
displayTime:  ; Display Time Routine
    ; Display Hour (Assuming currentHour is a two-digit number)
    mov al, currentHour
    ...
    ; Display Minute (Assuming currentMinute is a two-digit number)
    ...
    ; Display Second (Assuming currentSecond is a two-digit number)
